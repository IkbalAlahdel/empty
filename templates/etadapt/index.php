...
if (file_exists($helix_path)) {
    ...
    die('Install and activate <a target="_blank" href="https://www.enginetemplates.com/helix">Helix Ultimate Framework</a>.');
}
...
<html lang="en">
    <head>
        ...
        $theme->add_js('jquery.custom.js, custom.js');

        $theme->add_scss('master', $scssVars, 'template');
        $theme->add_scss('default', $scssVars, 'default');
        $theme->add_scss('color-preset', $scssVars, 'color-preset');
